...
terrain = new terrain_map_struct(terrain_sprite,contour_sprite,left,top,width,length,height_min,height_max,water_ratio,color1,color2,color_water,color_value);
terrain.initialize();
